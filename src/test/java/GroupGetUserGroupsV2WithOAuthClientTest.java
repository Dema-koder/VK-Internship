...
public class GroupGetUserGroupsV2WithOAuthClientTest {
    ...
    void mapSetUp() {
        ...
        baseParams.put("access_token", ACCESS_TOKEN);
        baseParams.put("permissions", "VALUABLE_ACCESS;LONG_ACCESS_TOKEN");
    }
    ...
    private String generateSig(Map<String, String> params) {
        ...
        sortedParams += SESSION_SECRET_KEY;
    ...
    void testMissingRequiredParameters() {
        ...
        params.put("permissions", "VALUABLE_ACCESS;LONG_ACCESS_TOKEN");
